...
# Pin Definitions
motor_a_pwm_pin = machine.Pin(14)  # GP18 as PWM pin for motor speed control
motor_a_in1_pin = machine.Pin(15,Pin.OUT)  # GP19 as IN1 pin for motor direction control
motor_a_in2_pin = machine.Pin(16,Pin.OUT)  # GP20 as IN2 pin for motor direction control
